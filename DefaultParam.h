...
namespace ParaMeters{
    ...
    enum Area{
        AreaV1,AreaV2,AreaVP,AreaV3,AreaV3A,
        AreaMT,AreaV4t,AreaV4,AreaVOT,AreaMSTd,
        AreaPIP,AreaPO,AreaDP,AreaMIP,AreaMDP,AreaVIP,
        AreaLIP,AreaPITv,AreaPITd,AreaMSTl,AreaCITv,
        AreaCITd,AreaFEF,AreaTF,AreaAITv,AreaFST,Area7a,
        AreaSTPp,AreaSTPa,Area46,AreaAITd,AreaTH,AreaMax,
    };
    enum Population{
    ...
    const string areaNames[AreaMax] = {
        "V1","V2","VP","V3","V3A",
        "MT","V4t","V4","VOT","MSTd",
        "PIP","PO","DP","MIP","MDP","VIP",
        "LIP","PITv","PITd","MSTl","CITv",
        "CITd","FEF","TF","AITv","FST","7a",
