...
DataPath=os.path.join("/home/yangjinhao/GeNN/userproject/MultiArea/custom_Data_Model_3396.json")
file1=os.path.join("/home/yangjinhao/GeNN/userproject/MultiArea/SynapsesWeight.txt")
file3=os.path.join("/home/yangjinhao/GeNN/userproject/MultiArea/SynapsesNumber.txt")
file2=os.path.join("/home/yangjinhao/GeNN/userproject/MultiArea/NeuronNumber.txt")
